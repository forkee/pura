TOR SUPPORT IN PURA CORE
=======================

It is possible to run Pura Core as a Tor hidden service, and connect to such services.
...
1. Run Pura Core behind a Tor proxy
----------------------------------

The first step is running Pura Core behind a Tor proxy. This will already make all
...
2. Run a Pura Core hidden server
-------------------------------
...
config file):
	...
	HiddenServiceDir /var/lib/tor/puracore-service/
...
your purad's P2P listen port (44444 by default).
	...
	-externalip=X   You can tell Pura Core about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/puracore-service/hostname. Onion addresses are given
...
3. List of known Pura Core Tor relays
------------------------------------
...
Pura Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Pura Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Pura Core is listening, and
