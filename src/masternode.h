...
//
// The Masternode Class. For managing the PrivatePay process. It contains the input of the 1000 PURA, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 PURA - checking if valid masternode)
