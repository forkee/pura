...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PuraCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PuraCore
    // Mac: ~/Library/Application Support/PuraCore
    // Unix: ~/.puracore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PuraCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PuraCore";
#else
    // Unix
    return pathRet / ".puracore";
#endif
#endif
}
